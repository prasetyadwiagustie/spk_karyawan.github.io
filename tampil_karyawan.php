...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div><a href="input_karyawan.php" class="btn btn-info">Tambah Data</a>   
				<tr><a href="tampil_karyawanrestore.php" class="btn btn-info">Restore Data</a><tr><br></div>
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $no=1; foreach($db->select('*','karyawan')->where('status=0')->get() as $data): ?>
                            <tr>
                                <td><?= $data['NIK'];?></td>
                                <td><?= $data['nama']?></td>
