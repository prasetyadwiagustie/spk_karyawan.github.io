        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                foreach ($db->select('karyawan.nama,hasil_tpa.*','karyawan,hasil_tpa')->where('karyawan.id_calon_kr=hasil_tpa.id_calon_kr')->and ('karyawan.status=0')->get() as $data):
                            ?>
                                <tr>
                                    <td><?= $data['nama']?></td>
            ...
            <div id="proses_spk" style="display: none;">
                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                foreach ($db->select('karyawan.nama,hasil_tpa.*','karyawan,hasil_tpa')->where('karyawan.id_calon_kr=hasil_tpa.id_calon_kr')->and('status=0')->get() as $data):
                            ?>
                                <tr>
                                    <td><?= $data['nama']?></td>
                                    <?php foreach ($db->select('kriteria','kriteria')->get() as $td): ?>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table id="example3" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                foreach ($db->select('karyawan.id_calon_kr,karyawan.nama,hasil_tpa.*','karyawan,hasil_tpa')->where('karyawan.id_calon_kr=hasil_tpa.id_calon_kr')->and('status=0')->get() as $data):
                            ?>
                                <tr>
                                    <td><?= $data['nama']?></td>
                                    <td>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12 text-center">
                    <button class="btn btn-lg" onclick="window.open ('lap_penilaian.php', ''); 
 return false" href="javascript:void(0);"  id="sk"> Cetak Hasil</button> </div>
                </div>
            </div>    
            </div>
