            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $no=1; foreach($db->select('karyawan.id_calon_kr,karyawan.nama,karyawan.status,hasil_tpa.*','karyawan,hasil_tpa')->where('karyawan.id_calon_kr = hasil_tpa.id_calon_kr')->and ('status=0')->get() as $data): ?>
                            <tr>
                                <td><?= $no;?></td>
                                <td><?= $data['nama']?></td>
