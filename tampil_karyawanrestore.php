...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Recycle Bin Data Karyawan </h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <!--<tr><div><a href="input_karyawan.php" class="btn btn-info">Tambah Data</a></div></tr>      <div><tr><a href="input_karyawan.php" class="btn btn-info">Restore Data</a></div><tr><br>-->
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $no=1; foreach($db->select('*','karyawan')->where('status=1')->get() as $data): ?>
                            <tr>
                                <td><?= $data['NIK'];?></td>
                                <td><?= $data['nama']?></td>
                              ...
                              <!--  <td>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="deletetotal_karyawanrestore.php?id=<?php echo $data[0]?>" >Hapus</a>
                                    <a class="btn btn-danger"  onclick="return confirm('Yakin Restore?')" href="delete_karyawanrestore.php?id=<?php echo $data[0]?>">Restore</a>
                                </td>
                            </tr>
                            <?php $no++; endforeach; ?>
                        </tbody>
